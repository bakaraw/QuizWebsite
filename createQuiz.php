    ...
    <form action="" method="get">
        <div class="bg-light p-3 rounded-4 mt-3" style="--bs-bg-opacity: .05;">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-light border-light" id="exampleFormControlTextarea1" rows="3" style="--bs-border-opacity: .2;" name="question"></textarea>
            </div>
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-outline-light add-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Add Question">
                    <img src="assets/img/icons/plus-square-fill.svg" alt="Add Question" style="width: 24px; height: 24px; fill: white;">
                </button>
            </div>
        </div>

        <label class="text-light" for="try">
            hello
        </label>
    </form>
</div>
